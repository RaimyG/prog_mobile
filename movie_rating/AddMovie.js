    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TextInput placeholder="Résumé du film" value={this.state.resume} onChangeText={this.handleResumeChange} style={[styles.input, styles.resume]} />
                <TextInput placeholder="Commentaire" value={this.state.comment} onChangeText={this.handleCommentChange} style={styles.input} />
                {/* <TextInput placeholder="Note" value={this.state.note} onChangeText={this.handleNoteChange} style={styles.input} /> */}
                <AirbnbRating
                    count={5}
